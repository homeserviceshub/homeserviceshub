...
// error in file that when clicked on next in handle2 the currentstate shows 0 and it doesnot work further

const ServiceRequest = () => {
  //   code for scroll to the next div
  ...
  //     setShowCards(true);
  //     scrollToCard(secondCardRef);
  //   };

  //   const handleClickCard2 = () => {
  //     scrollToCard(thirdCardRef);
  //   };
  ...
  //       <div>
  //         <h2>Card 1</h2>
  //         <button onClick={handleClickCard1}>Go to Card 2</button>
  //       </div>
  //       {showCards && (
  //         <div>
  //           <h2>Card 2</h2>
  //           <button onClick={handleClickCard2}>Go to Card 3</button>
  //         </div>
  //       )}
  //       {showCards && (
  //         <div>
  ...
  //         </div>
  //       )}
  //       <div ref={secondCardRef}></div>
  //       <div ref={thirdCardRef}></div>
  //     </div>
  //   );
  // };
  ...
  const handleClickCard1 = (e) => {
    e.preventDefault();
    console.log(currentStep, "in first div");
    if (currentStep === 0) {
      const newCard = (
        <div key={1}>
          <div className={styles.main}>
            ...
            <div className={styles.bothIcons}>
              <div className={styles.icon}>
                {/* selected class is created add the fuctionality onClick */}
  ...
  const handleClickCard2 = (e) => {
    e.preventDefault();
    console.log(currentStep, "in second div");
    if (currentStep === 1) {
      const newCard = (
        <div key={2}>
          <div className={styles.main}>
                ...
                return (
                  <div key={index} className={styles.radioDiv}>
                    <input
                      ...
                      value={item.lable}
                    />
                    <label for={item.lable}>{item.name}</label>
                  </div>
                );
              })}
            </div>
  ...
  const handleClickCard3 = (e) => {
    ...
    if (currentStep === 2) {
      ...
      if (cards.length === 3) {
        setCards([cards[0], cards[1], newCard]);
    ...
    <div>
      ...
      <div className={styles.main}>
        ...
        <Form>
          ...
          <Form.Group className={styles.btn}>
            <CustomButton text={"Next"} onClick={handleClickCard1} />
          </Form.Group>
        </Form>
      </div>
